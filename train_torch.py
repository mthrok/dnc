...
import torch
from torch_dnc.repeat_copy import RepeatCopy
from torch_dnc.dnc import DNC
...
def _main():
    ...
    dataset = RepeatCopy(
        args.num_bits, args.batch_size,
        args.min_length, args.max_length,
        args.min_repeats, args.max_repeats)
...
def _parse_args():
    ...
    model_opts.add_argument(
        "--clip-value", type=float, default=20,
    ...
    optim_opts.add_argument(
        "--learning-rate", "--lr", type=float, default=1e-4, dest="lr",
        help="Optimizer learning rate.")
    optim_opts.add_argument(
        "--optimizer-epsilon", type=float, default=1e-10, dest="eps",
